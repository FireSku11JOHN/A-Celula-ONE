...
import { useAnimationHeroSection } from "../animations/useAnimationHeroSection"
    ...
    return (
        <div ref={containerRef} className="flex w-full h-screen overflow-hidden">
            <div className="absolute inset-0 left-1/2 -translate-x-1/2 flex w-full items-center justify-around max-sm:flex-col max-sm:justify-center max-sm:gap-4">
                ...
                <div ref={paragraphRef} className="mt-8 max-w-120 w-[60%] px-6 text-center text-white max-md:w-full">
                    <p className="TitilliumWeb-HeroSection text-lg leading-relaxed text-left max-md:text-[16px] max-md:text-center">
