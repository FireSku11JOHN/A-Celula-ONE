    ...
    return (
        <div ref={triggerRef} className="overflow-hidden z-10">
            ...
            <div ref={sectionRef} className="flex w-fit h-screen">
                ...
                <div className="w-screen gradient-secondary-to-primary bg-[url('/src/assets/fundo-dunas-branca.svg')] bg-cover bg-center bg-no-repeat flex items-center justify-evenly
                px-4 py-.0 max-md:flex-col max-md:justify-between max-md:items-start max-md:gap-10 max-md:py-10">
                    {/* <div>
                        <img className="w-[90%] max-w-[485px] height-auto rounded-2xl max-md:w-[40%]" src={img1} alt="" />
                    </div> */}
                    <div className="w-full h-sceen max-w-204 bg-cover bg-no-repeat">
                    <img className="rounded-[100px]" src={img1} alt="" />
                    </div>
                    <div className="relative flex flex-col items-center p-10 rounded-2xl max-w-[35%] max-md:max-w-[55%] max-md:self-end max-md:mr-4 max-md:px-6">
