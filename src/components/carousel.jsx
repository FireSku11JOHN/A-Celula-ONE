    ...
    return (
        <div ref={triggerRef} className="overflow-hidden z-10">
            ...
            <div ref={sectionRef} className="flex w-fit h-screen">
                ...
                <div className="w-screen bg-primary bg-[url('/src/assets/fundo-dunas-branca.svg')] bg-cover bg-center bg-no-repeat flex items-center justify-evenly
                px-4 py-20 max-md:flex-col max-md:justify-between max-md:items-start max-md:gap-10 max-md:py-10">
                    ...
                    <div className="w-full max-w-204 h-[calc(100vh-40px)] rounded-2xl bg-[url('/src/assets/teste-one-4.jpg')] bg-cover bg-center bg-no-repeat">
